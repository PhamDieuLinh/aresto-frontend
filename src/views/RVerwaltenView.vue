    ...
    <div class="row g-0">
      <div id="s" class="col">
        <form class="d-flex" role="search">
          ...
          <button class="btn btn-outline-succes" type="submit" style="border-color: gold" v-on:click="search">Neue Suche</button>
        </form>
      </div>

      <div id="ad" class="col">
        <!-- Button trigger modal -->
        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#rerstellen-staticBackdrop">
        ...
        <div class="card mb-3" style="max-width: 1200px;">
          <div class="row g-0">
            ...
            <div id="btn" class="col-md-2">
              ...
              <!-- Button trigger modal -->
              <button type="button" class="btn btn-outline-warning" data-bs-toggle="modal" data-bs-target="#rbearbeiten-staticBackdrop" @click="saveRes(restaurant)">
                Bearbeiten
              </button>
...
export default {
  ...
  methods: {
    ...
    saveRes (res) {
      ...
      console.log(this.restaurantToEdit.name)
    },
    compareNames (a, b) {
